...
<div id="text_epayco_status_map" class="in collapse">
    <p>{__('epayco_ipn_note') nofilter}</p>
    <div class="control-group">
        <strong class="control-label">{__('epayco_ipn_transaction_status')}</strong>
        <div class="controls">
    ...
    <div class="control-group">
        <label class="control-label" for="elm_epayco_refunded">{__("refunded")}:</label>
        <div class="controls">
            <select name="pp_settings[pp_statuses][refunded]" id="elm_epayco_refunded">
    ...
    <div class="control-group">
        <label class="control-label" for="elm_epayco_completed">{__("completed")}:</label>
        <div class="controls">
            <select name="pp_settings[pp_statuses][completed]" id="elm_epayco_completed">
                {foreach from=$statuses item="s" key="k"}
    ...
    <div class="control-group">
        <label class="control-label" for="elm_epayco_pending">{__("pending")}:</label>
        <div class="controls">
            <select name="pp_settings[pp_statuses][pending]" id="elm_epayco_pending">
                {foreach from=$statuses item="s" key="k"}
    ...
    <div class="control-group">
        <label class="control-label" for="elm_epayco_canceled_reversal">{__("canceled_reversal")}:</label>
        <div class="controls">
            <select name="pp_settings[pp_statuses][canceled_reversal]" id="elm_epayco_canceled_reversal">
                {foreach from=$statuses item="s" key="k"}
    ...
    <div class="control-group">
        <label class="control-label" for="elm_epayco_created">{__("created")}:</label>
        <div class="controls">
            <select name="pp_settings[pp_statuses][created]" id="elm_epayco_created">
                {foreach from=$statuses item="s" key="k"}
    ...
    <div class="control-group">
        <label class="control-label" for="elm_epayco_denied">{__("denied")}:</label>
        <div class="controls">
            <select name="pp_settings[pp_statuses][denied]" id="elm_epayco_denied">
                {foreach from=$statuses item="s" key="k"}
    ...
    <div class="control-group">
        <label class="control-label" for="elm_epayco_expired">{__("expired")}:</label>
        <div class="controls">
            <select name="pp_settings[pp_statuses][expired]" id="elm_epayco_expired">
                {foreach from=$statuses item="s" key="k"}
    ...
    <div class="control-group">
        <label class="control-label" for="elm_epayco_reversed">{__("reversed")}:</label>
        <div class="controls">
            <select name="pp_settings[pp_statuses][reversed]" id="elm_epayco_reversed">
                {foreach from=$statuses item="s" key="k"}
    ...
    <div class="control-group">
        <label class="control-label" for="elm_epayco_processed">{__("processed")}:</label>
        <div class="controls">
            <select name="pp_settings[pp_statuses][processed]" id="elm_epayco_processed">
                {foreach from=$statuses item="s" key="k"}
    ...
    <div class="control-group">
        <label class="control-label" for="elm_epayco_voided">{__("voided")}:</label>
        <div class="controls">
            <select name="pp_settings[pp_statuses][voided]" id="elm_epayco_voided">
                {foreach from=$statuses item="s" key="k"}
    ...
    <div class="control-group">
        <label class="control-label" for="elm_epayco_failed">{__("failed")}:</label>
        <div class="controls">
            <select name="pp_settings[pp_statuses][failed]" id="elm_epayco_failed">
                {foreach from=$statuses item="s" key="k"}
